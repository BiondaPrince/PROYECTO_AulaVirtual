    ...
    <div className="course-week-page container">
      ...
      <div className="week-page-content mt-3">
        <section>
          ...
          <p>Hilos y respuestas. Pulsa "Ver hilo" para leer y responder.</p>
          ...
          <div className="forum-list mt-3">
            {threads.length === 0 && <p>No hay hilos publicados.</p>}
            {threads.map(t => (
              <div key={t.id} className="card mb-2">
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-start">
                    ...
                    <div>
                      <button className="btn btn-sm btn-outline-primary" onClick={() => toggleThread(t.id)}>{expandedThreads.includes(t.id) ? 'Cerrar' : 'Ver hilo'}</button>
                    </div>
                  </div>
